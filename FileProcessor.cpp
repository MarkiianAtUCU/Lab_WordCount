...
void FileProcessor::process_archive(std::string path, std::vector<std::string> & vss) {
    struct archive *a;
...
void FileProcessor::process_file(std::string path, std::vector<std::string> &vss) {
...
bool FileProcessor::is_archive(boost::filesystem::path & entry) {
...
bool FileProcessor::is_text(boost::filesystem::path & entry) {
